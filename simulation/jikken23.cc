...
private:
  ...
  uint32_t m_port;
  uint32_t m_sourceNode[10];
  uint32_t m_sinkNode[10];              
...
private:
  ...
  uint32_t m_sourceNode[10];//送信ノード
  uint32_t m_sinkNode[10];//受信ノード
...
m_packetLoss (0),
m_numHops(0),
m_traceFile("/home/hry-user/ノード/mobility.tcl"),
